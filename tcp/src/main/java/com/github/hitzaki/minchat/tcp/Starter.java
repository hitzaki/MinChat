package com.github.hitzaki.minchat.tcp;

import com.github.hitzaki.minchat.tcp.register.RegistryZK;
import com.github.hitzaki.minchat.codec.config.BootstrapConfig;
import com.github.hitzaki.minchat.tcp.reciver.MessageReciver;
import com.github.hitzaki.minchat.tcp.redis.RedisManager;
import com.github.hitzaki.minchat.tcp.register.ZKit;
import com.github.hitzaki.minchat.tcp.server.LimServer;
import com.github.hitzaki.minchat.tcp.server.LimWebSocketServer;
import com.github.hitzaki.minchat.tcp.utils.MqFactory;
...
//    HTTP GET POST PUT DELETE 1.0 1.1 2.0
    ...
    private static void start(String path){
        try {
            Yaml yaml = new Yaml();    // 解析自己的YAML文件
