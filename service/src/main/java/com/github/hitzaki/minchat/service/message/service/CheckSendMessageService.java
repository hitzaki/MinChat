...
import com.github.hitzaki.minchat.common.enums.*;
import com.github.hitzaki.minchat.service.friendship.dao.ImFriendShipEntity;
import com.github.hitzaki.minchat.service.friendship.model.req.GetRelationReq;
...
public class CheckSendMessageService {
    ...
    public ResponseVO checkFriendShip(String fromId,String toId,Integer appId){
        ...
        if(appConfig.isSendMessageCheckFriend()){
            ...
            ResponseVO<ImFriendShipEntity> fromRelation = imFriendService.getFriendShip(fromReq);
            ...
            fromReq.setAppId(appId);
            ResponseVO<ImFriendShipEntity> toRelation = imFriendService.getFriendShip(fromReq);
            if(!toRelation.isOk()){
                return toRelation;
            }
