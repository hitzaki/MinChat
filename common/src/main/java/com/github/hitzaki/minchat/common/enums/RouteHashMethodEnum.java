...
public enum RouteHashMethodEnum {
     ...
     * TreeMap
     */
    TREE(1,"com.github.hitzaki.minchat.common.route.algorithm.consistenthash" +
            ".TreeMapConsistentHash"),

    /**
     * 自定义map
     */
    CUSTOMER(2,"com.github.hitzaki.minchat.common.route.algorithm.consistenthash.xxxx"),
